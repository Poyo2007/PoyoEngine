	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				var tex = Paths.getSparrowAtlas('characters/gf/GF_assets');

				switch PlayState.curStage.toLowerCase() {
					case 'spooky':
						tex = jointex(tex, Paths.getSparrowAtlas('characters/gf/GF_assets_week2'));
					case 'stage':
						if (PlayState.SONG.song.toLowerCase() == 'tutorial')
						{
							tex = jointex(tex, Paths.getSparrowAtlas('characters/gf/GF_assets_tutorial'));
						}
					case 'philly':
						tex = jointex(tex, jointex(Paths.getSparrowAtlas('characters/gf/GF_assets_blowing'), Paths.getSparrowAtlas('characters/gf/GF_ass_sets_landing')));
